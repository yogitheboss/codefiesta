...
const Footer = () => {
    return (
        <div className='	 '>
            ...
            <footer className="mt-8 bg-white rounded-lg shadow m-4 dark:bg-gray-800">
                <div className="w-full mx-auto max-w-screen-xl p-2 md:flex md:items-center md:justify-between h-20 mt-12">
